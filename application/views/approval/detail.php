...
<?php if (!empty($rka)): ?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Hak anda sebagai Approval</h3>
        </div>
        <ul class="list-group" id="accordion">
    	<?php if ($database->status == "checked"): ?>
          <a href="<?php echo site_url('approval/approveanggaran/') . $this->uri->segment(3); ?>" title="">
			<li class="list-group-item"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>Approve</li>
          </a>
          <a href="<?php echo site_url('approval/declineanggaran/') . $this->uri->segment(3); ?>" title="">
			<li class="list-group-item"><i class="fa fa-trash" aria-hidden="true"></i>Decline</li>
          </a>
          <?php elseif ($database->status == "approved"): ?>          	
